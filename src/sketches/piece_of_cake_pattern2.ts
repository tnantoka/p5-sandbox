  ...
  p.draw = () => {
    ...
    function drawPiece(angle: number) {
...

      {
        ...
        const x1 = center.x + radius * 0.25 * p.cos(p.radians(-90));
        const y1 = center.y + radius * 0.25 * p.sin(p.radians(-90));
...

      {
        ...
        const x1 = center.x + radius * 0.25 * p.cos(p.radians(-90 + angle));
        const y1 = center.y + radius * 0.25 * p.sin(p.radians(-90 + angle));
...

      {
        ...
        const x1_25 =
          center.x + radius * 0.95 * p.cos(p.radians(-90 + angle * 0.3));
        const y1_25 =
          center.y + radius * 0.95 * p.sin(p.radians(-90 + angle * 0.3));

        const x1_5 =
          center.x + radius * 0.75 * p.cos(p.radians(-90 + angle * 0.5));
        const y1_5 =
          center.y + radius * 0.75 * p.sin(p.radians(-90 + angle * 0.5));

        const x1_75 =
          center.x + radius * 0.95 * p.cos(p.radians(-90 + angle * 0.7));
        const y1_75 =
          center.y + radius * 0.95 * p.sin(p.radians(-90 + angle * 0.7));

        const x2 = center.x + radius * 0.7 * p.cos(p.radians(-90 + angle));
        const y2 = center.y + radius * 0.7 * p.sin(p.radians(-90 + angle));

        p.line(x1, y1, x1_25, y1_25);
        p.line(x1_25, y1_25, x1_5, y1_5);
        p.line(x1_5, y1_5, x1_75, y1_75);
        p.line(x1_75, y1_75, x2, y2);
      }
    }
  };
